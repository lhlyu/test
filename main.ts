const config = {
    ...
    prompt: {
        ...
        types: [
            ...
            { value: 'chore', name: '回退:     回滚 commit' },
            { value: 'revert', name: '其他:     对构建过程或辅助工具和库的更改（不影响源文件、测试用例）' },
        ],
        scopes: ["hotaru", "app", "forest", "generator", "hanabi", "player", "shared"],
        useEmoji: false,
        emojiAlign: 'center',
        useAI: false,
        aiNumber: 1,
...
console.log(JSON.stringify(config.prompt, null, 4));